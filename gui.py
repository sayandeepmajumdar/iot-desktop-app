...
def lightoff():
   ...
   URL = "https://api.thingspeak.com/update?api_key=2D8FC6ORJWW9I6BR"
...
def lighton():
   ...
   arduinoData = 1
   # print("Data:", arduinoData)
   URL1 = "https://api.thingspeak.com/update?api_key=2D8FC6ORJWW9I6BR"
...
def dataToArduino():
   ...
   # while 1:
   URL2 = "https://api.thingspeak.com/channels/834537/fields/1.json?api_key=9AHX4930MXYK8W0L"
